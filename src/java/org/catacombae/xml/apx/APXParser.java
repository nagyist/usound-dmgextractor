...
/* For convenience, this method returns the encoding. We need to determine that before anything else. */
  final public String xmlDecl() throws ParseException {String version, encoding = null;
...
contentHandler.xmlDecl(version, encoding, standalone); {if ("" != null) return encoding;}
    throw new Error("Missing return statement in function");
  }

  final public String versionInfo() throws ParseException {Token versionString;
...
{if ("" != null) return versionString.image;}
    throw new Error("Missing return statement in function");
  }

  final public String encodingDecl() throws ParseException {Token encoding;
...
{if ("" != null) return encoding.image;}
    throw new Error("Missing return statement in function");
  }

  final public boolean sdDecl() throws ParseException {boolean b;
...
// Needs more work to support inline DTD declarations
  final public void doctypeDecl() throws ParseException {Token name;
...
//}
  final public 
void misc() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case STARTCOMMENT:{
      comment();
      break;
  ...
  final public void comment() throws ParseException {Token t;
...
contentHandler.comment(sb.toString());
  ...
  final public void pi() throws ParseException {Token target;
...
// returns the content of the processor instruction, minus the trailing "?>"
  final public StringBuilder piContent() throws ParseException {Token t;
        StringBuilder sb = new StringBuilder();
    label_5:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return sb;}
  ...
  final public void element() throws ParseException {String name;
...
contentHandler.startElement(name, attributes);
  ...
  final public String elementname() throws ParseException {Token t;
...
{if ("" != null) return new Attribute(name, new Attribute.Value(value));}
    throw new Error("Missing return statement in function");
  }

  final public void etag(String startName) throws ParseException {String name;
...
if(startName.equals(name))
  ...
  final public void content() throws ParseException {//StringBuilder sb = new StringBuilder();
        Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CHARDATA:{
      charData();
  ...
  final public void charData() throws ParseException {Token t;
...
contentHandler.chardata(beginLine, beginColumn, t.endLine, t.endColumn);
  ...
  final public void cdSect() throws ParseException {Token t;
